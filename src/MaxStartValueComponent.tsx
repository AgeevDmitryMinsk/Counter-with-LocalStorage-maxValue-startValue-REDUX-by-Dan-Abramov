...
export const MaxStartValueComponent: React.FC<MaxStartValueComponentType> = ({
	...
	let inputValueCSS = startValue === maxValue ? "inputValue inputValue_incorrect" : "inputValue"
	let inputStartValueCSS = (startValue === maxValue) || (startValue < 0) ? "inputValue inputValue_incorrect" : "inputValue"
	let universalButtonSetCSS = (startValue === maxValue) || (startValue < 0) ? "button_set button_opac" : "button_set"
	...
	// const  disabledOnConditionSet = (count:number) => {
	// 	callBackDisabledOnConditionSet(count)
	// }
